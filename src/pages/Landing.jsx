...
function Landing() {
  ...
  return (<>
    <div className="flex items-center flex-col">
      <h2 className="my-8 text-center text-3xl font-extrabold lg:text-5xl sm:my-14 sm:text-6xl bg-gradient-to-r from-blue-200 via-violet-400 to-indigo-600 bg-clip-text text-transparent p-2">Đừng để URL làm chậm bước tiến của bạn, hãy để chúng tôi tối ưu hóa đường đi cho bạn 👇</h2>
